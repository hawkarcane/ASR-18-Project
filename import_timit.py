...
def _preprocess_data(args):
    ...
    timit_df.to_hdf(args.features_to_save, "timit")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--features_to_save', type=str, default="./features/mfcc/timit.hdf",
                       help='Set to "./features/mfcc/timit.hdf" as default optional arg to change where feature dump file is saved.')
